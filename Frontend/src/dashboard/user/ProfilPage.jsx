            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <p className="text-[11px] text-neutral mt-1.5">
                  ...
                  Untuk keamanan, perubahan email dilakukan di <button type="button" onClick={() => onNavigate('pengaturan')} className="text-tertiary font-semibold hover:underline">Pengaturan</button>
                </p>
              </div>
              <div>
